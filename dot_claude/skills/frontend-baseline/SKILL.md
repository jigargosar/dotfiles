...
7. Interactive elements must have a target hit area of at least 24×24 CSS px (WCAG 2.2 AA), with 44×44 as the goal. This applies to every interactive element regardless of type or visual size.
